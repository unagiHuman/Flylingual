...
2026-09-15の取りこぼし調査後のユーザー承認により、clarifyをroute hintの操作へ置換する例外を撤回した。音声・直接入力とも解釈できない指示は確認を返し、任意の方向へ変更しない。既に受理された明示的な移動の補助・Brain経路・安全制御は維持する。[調査と修正結果](windows/Ignored-Voice-Commands-Investigation-20260915.md)を参照。
