...
{
    /// <summary>Title and first-run instructions in the gameplay scene.</summary>
    ...
    public sealed class TitleScreen : MonoBehaviour
    {
        ...
        Font font;
        VisualElement cover;
        Label heading, subtitle, instructions, connectionStatus;
        Button start, retryConnection;
        ...
        bool coverVisible = true, tutorial;
        ...
        void Update()
        {
            if (coverVisible) RefreshConnection();
        }
