...
_MESSAGES = {
    ...
    'en': {
        'unknown': "I can't quite tell how I'm doing right now.", 'invalid': "I can't quite tell how I'm doing right now.",
        ...
        'submitted': "Okay, I'll try. I can't tell yet how that's going.",
        'applied': "Your request reached me. I can't tell yet how I'm moving.",
        'intent_sent': "Okay, I'll try.",
        'clarify': "I didn't quite catch what you'd like me to do. Could you put it another way?",
        'rejected': "I couldn't carry out that request right now.",
        'incomplete_utterance': "I didn't catch all of that. Could you say it again?",
        'target_changed': "Things have changed. I'll need a moment before I can tell you how I'm doing.",
    },
}
